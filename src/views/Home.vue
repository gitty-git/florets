<template>
    <div class="absolute w-full">
        <!-- Баннер -->
        <transition appear enter-active-class="transform delay-500 duration-700 ease-out"
        ...
        <!-- Букеты -->
        <div id="bouquets"></div>
        <transition appear enter-active-class="transition transform ease-out delay-300 duration-500"
                    enter-from-class="opacity-0">

            <div v-if="products" class="py-16 flex justify-center">
            <div class="max-w-screen-xl px-6">
                ...
                <div class="lg:grid-cols-4 md:grid-cols-2 grid gap-12 lg:px-0 px-12">
        ...
        <!-- О нас -->
        <transition appear enter-active-class="transition transform delay-500 duration-500 ease-out"
                    enter-from-class="opacity-0">
            <div id="about"
                 class="bg-gradient-to-b flex justify-center from-gray-100 shadow-inner shadow-gray-200 pt-16 mb-20">
