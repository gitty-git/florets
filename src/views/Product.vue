<template>
    <div class="absolute w-full">
        <transition appear enter-active-class="transition transform duration-500 ease-out"
            ...
            <div>
                <div id="product" class="px-6 m-0 m-auto pt-16 pb-20 max-w-screen-xl">
                    ...
                    <div class="flex lg:flex-row flex-col">
                        <div class="lg:w-1/2 w-full mb-12 sm:flex-row flex-col flex justify-between">
                            <div class="relative mb-6 sm:mb-0 object-cover w-full sm:w-4/5 sm:pr-3">
                                <img v-show="!mainImageLoaded" class="w-full" :src="require(`@/assets/images/plug.png`)" alt="">
                                <transition appear enter-active-class="-transition transform duration-500 ease-out"
                                            enter-from-class="opacity-0">
                                    <img v-if="product" v-show="mainImageLoaded"
                                         @load="mainImageLoaded = true" class="top-0 left-0" :src="mainImage" alt="">
                                </transition>
                            </div>
