                    ...
                    <div class="mt-6 mb-4">
                        <svg width="80" height="54" viewBox="0 0 43 27" class="fill-white" xmlns="http://www.w3.org/2000/svg">
                            <path class="fill-white" fill-rule="evenodd" clip-rule="evenodd"
                                  ...
                                  fill="#F7A9B4"/>
                            <path class="fill-white" d="M42.4539 13.0258C34.9266 10.7004 29.8306 12.1333 27.9052 12.5818C29.7488 14.6491 34.8179 15.2026 38.8625 14.8371C44.1014 14.021 43.003 13.3732 42.4539 13.0258Z"
                                  fill="#F7A9B4"/>
                            <path class="fill-white" d="M28.9649 17.1626C27.1107 12.6967 22.9203 12.2374 21.5974 12.2357C22.1237 14.6234 24.4168 16.4686 26.9037 17.3231C28.8363 17.8347 29.2012 17.6173 28.9649 17.1626Z"
                                  fill="#F7A9B4"/>
                            <path class="fill-white" d="M34.2407 8.63133C26.397 8.36655 23.6 10.8237 22.081 12.0854C24.6666 13.1026 29.4256 12.5475 32.9877 10.7175C35.6293 9.19847 34.8892 8.69518 34.2407 8.63133Z"
                                  fill="#F7A9B4"/>
                            <path class="fill-white" d="M17.9172 8.51987C14.1343 10.2959 11.363 12.3606 11.7272 13.1314C12.4765 12.9246 15.4532 13.0874 19.2361 11.3114C23.0189 9.5353 25.306 7.43393 25.2052 6.567C24.6851 6.0984 21.7 6.74382 17.9172 8.51987Z"
                                  fill="#F7A9B4"/>
                        </svg>
                    </div>
...
<!--                                  d="M30.3854 12.8158C30.3981 12.7197 30.3306 12.6315 30.2346 12.6188C25.4653 11.9851 12.8194 11.427 0.326099 14.2559C0.231606 14.2773 0.172348 14.3712 0.193744 14.4657C0.215141 14.5602 0.309089 14.6195 0.403582 14.5981C12.8476 11.7803 25.4504 12.337 30.1884 12.9666C30.2844 12.9793 30.3726 12.9118 30.3854 12.8158Z"-->
<!--                                  fill="#F7A9B4"/>-->
<!--                            <path d="M42.4539 13.0258C34.9266 10.7004 29.8306 12.1333 27.9052 12.5818C29.7488 14.6491 34.8179 15.2026 38.8625 14.8371C44.1014 14.021 43.003 13.3732 42.4539 13.0258Z"-->
<!--                                  fill="#F7A9B4"/>-->
<!--                            <path d="M28.9649 17.1626C27.1107 12.6967 22.9203 12.2374 21.5974 12.2357C22.1237 14.6234 24.4168 16.4686 26.9037 17.3231C28.8363 17.8347 29.2012 17.6173 28.9649 17.1626Z"-->
<!--                                  fill="#F7A9B4"/>-->
<!--                            <path d="M34.2407 8.63133C26.397 8.36655 23.6 10.8237 22.081 12.0854C24.6666 13.1026 29.4256 12.5475 32.9877 10.7175C35.6293 9.19847 34.8892 8.69518 34.2407 8.63133Z"-->
<!--                                  fill="#F7A9B4"/>-->
<!--                            <path d="M17.9172 8.51987C14.1343 10.2959 11.363 12.3606 11.7272 13.1314C12.4765 12.9246 15.4532 13.0874 19.2361 11.3114C23.0189 9.5353 25.306 7.43393 25.2052 6.567C24.6851 6.0984 21.7 6.74382 17.9172 8.51987Z"-->
<!--                                  fill="#F7A9B4"/>-->
<!--                        </svg>-->
<!--                    </div>-->
